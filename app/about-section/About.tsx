      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            <AnimatedBody
              text={
                "I specialize in crafting high-converting landing pages and websites and cross-paltform apps for SaaS, & AI startups. I'm passionate about building software that makes a difference."
              }
            />
            <AnimatedBody
              text={
            ...
            <AnimatedBody
              text={
                "When I'm not coding, you can find me binge-watching action movies, hanging out with friends, cheering on Brazil and Real Madrid, or discovering new music in my favorite genres like RnB, UK Drill, and Chill Rap."
              }
            />
            <AnimatedBody
              text={
          ...
          <div className="mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]">
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "JavaScript (ES6+), React,js, Next.js, TypeScript, Prismic CMS, Redux, Redux Toolkit, React Testing Library, Vitetest, HTML5, Git/GitHub, NextAuth, Formik"
                }
              />
            </div>
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "CSS3, Tailwind CSS, Material UI, Framer Motion, GSAP, Bootstrap CSS, Chart.js, Shadcn/UI"
                }
              />
            </div>
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Figma, Framer, Adobe XD, Adobe Photoshop, UX Research, UI Design, Prototyping."
                }
              />
            </div>
          </div>
